...
root.resizable(0, 0)
icon= ttk.PhotoImage(file= 'spiderman.png')
...
image_icon = ttk.PhotoImage(file = 'addd.png').subsample(12, 12)
...
img = Image.open("spiderman.png")
img.save("spiderman.ico", format='ICO')
